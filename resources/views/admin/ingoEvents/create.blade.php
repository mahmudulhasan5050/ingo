            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form id="exampleValidation" action="{{ url('admin/ingoevent') }}" method="post">
                            {!! csrf_field() !!}
                            <div class="card-body">
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="event_website"
                                            name="event_website" placeholder="Enter Event Website" required>
                                    </div>
                                </div>
                                <div class="form-group form-show-validation row">
                                        ...
                                        <div class="select2-input">
                                            <select id="age_restriction" name="age_restriction" class="form-control"
                                                ...
                                                @foreach ($ingoEvent['age_restriction_array'] as $item)
                                                    <option value="{{ $item }}">Age Limit: {{ $item }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="form-group form-show-validation row">
                                    <label for="birth" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Event
                                        Chain
                                        <span class="required-label">*</span></label>
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        <div class="select2-input">
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="ticket_amount"
                                            name="ticket_amount" placeholder="Enter Ticket Amount" required>
                                    </div>
                                </div>
