							...
							<div class="card card-primary bg-primary-gradient">
								<div class="card-body">
									...
									<ul class="list-unstyled">
										...
										<li class="d-flex justify-content-between pb-1 pt-1"><small>/product/Millenium/demo.html</small> <span>10</span></li>
									</ul>
								</div>
							</div>
						</div>
								...
								<div class="card-body">
									<ol class="activity-feed">
										...
										<li class="feed-item feed-item-info">
											...
											<span class="text">Joined the group <a href="single-group.php.html">"Boardsmanship Forum"</a></span>
										</li>
										...
										<li class="feed-item">
											...
											<span class="text">Attending the event <a href="single-event.php.html">"Some New Event"</a></span>
										</li>
									</ol>
								</div>
							</div>
