        ...
        <div id="testimonials-slideshow" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
            <div class="carousel-inner">
                <div class="carousel-item active slide-element">
                    ...
                    <button class="btn register-button" type="button" name="button">Register as an event
                        organizer</button>
                </div>
                <div class="carousel-item slide-element">
                    ...
                    <button class="btn register-button" type="button" name="button">Register now</button>
                </div>
            </div>
